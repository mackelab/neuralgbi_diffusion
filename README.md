...
The diffusion model (`f_ψ(θτ, τ)`) follows the approach from [Denoising Diffusion Probabilistic Models](https://arxiv.org/abs/2006.11239) (Ho et al., 2020):
