...
class SBI(LightningModule):
    ...
    def training_step(self, batch: Tuple[Tensor, Tensor, Tensor], batch_idx: int):
        ...
        self.log("train/cost_corr", self.criterion.get_sample_correlation().mean(), on_epoch=True, on_step=False)
    ...
    def validation_step(self, batch: Tuple[Tensor, Tensor, Tensor], batch_idx: int):
        ...
        self.log("val/cost_corr", self.criterion.get_sample_correlation().mean(), on_epoch=True, on_step=False)
    ...
    def on_validation_epoch_end(self):
        ...
        tb_logger.experiment.add_figure("val/corr_plot", fig, global_step=self.global_step)
